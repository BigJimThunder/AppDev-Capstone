class OutfitItemsController < ApplicationController
  def index
    ...
    render({ :template => "outfit_items/index" })
  end
  ...
  def show
    ...
    render({ :template => "outfit_items/show" })
  end

  def create
    the_outfit_item = OutfitItem.new
    the_outfit_item.clothing_id = params.fetch("query_clothing_id")
    the_outfit_item.outfit_id = params.fetch("query_outfit_id")
    the_outfit_item.position = params.fetch("query_position")
